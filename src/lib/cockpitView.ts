...
export function pruneArchived(g: GraphState, isVisible: (sid?: string) => boolean): GraphState {
...
export function collapseByTitle(g: GraphState, titleOf: (sid: string) => string): GraphState {
