...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![set_glass, process::run_claude, process::stop_claude, vault::read_vault_file, vault::vault_index, vault::vault_links, vault::read_cartographicum, vault::read_folder_graph, sessions::list_sessions, sessions::read_session, session_watch::list_live_sessions, session_watch::watch_sessions])
