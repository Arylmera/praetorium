...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![set_glass, process::run_claude, process::stop_claude, vault::read_vault_file, vault::vault_index, vault::vault_links, sessions::list_sessions, sessions::read_session, sessions::list_all_sessions, session_watch::list_live_sessions, session_watch::watch_sessions])
